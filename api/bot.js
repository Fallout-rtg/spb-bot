...
const commentText = `
⚠️ <b>Краткие правила комментариев:</b>
...
• Любая политика или околополитический контент, касающийся событий в реальной жизни, запрещён.
...
await ctx.reply(commentText, { parse_mode: 'HTML', disable_web_page_preview: true });
